  ...
  return (
    <section className="py-16 sm:py-24 bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold" style={{ color: COLORS.navy }}>The AI Procurement Engine</h2>
        ...
        <div className="rounded-2xl border p-6 bg-[#f6f6fb] text-sm text-[#00003d]/80" style={{ borderColor: '#d5d5d5' }}>
