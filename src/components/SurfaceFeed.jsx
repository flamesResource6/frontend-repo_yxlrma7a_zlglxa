    ...
    <section className="py-16 sm:py-24 bg-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h2 className="mt-4 text-2xl sm:text-3xl font-bold" style={{ color: COLORS.navy }}>
        ...
        <div className="rounded-2xl border overflow-hidden bg-[#f6f6fb]" style={{ borderColor: '#d5d5d5' }}>
          {/* Placeholder for Figma design image embed */}
